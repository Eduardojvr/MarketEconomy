                            ...
                            <div slot="body">
                            	<form  id="form-modal" class="needs-validation" novalidate>
				                    <div class="form-group">
				                        ...
				                        <input class="form-control" id="nom_chav" placeholder="Nome do tipo" required type="text" v-model="novo.nom_empresa"/>
				                    ...
				                    <div class="form-group">
				                        ...
				                        <textarea class="form-control" id="descricao" rows="3" placeholder="Descreva em poucas palavras a empresa" v-model="novo.des_empresa" ></textarea>
				                    </div>
				                    <div class="form-group row">
				                        <input type="checkbox" class="custom-control-input" id="ind_parceira" v-model="novo.ind_parceira">
				                        <label class="custom-control-label" for="ind_parceira">Empresa parceira</label>
				                    </div>
			                	</form>
    ...
    module.exports = {
        ...
        methods: {
            ...
            salvar: function(){
                ...
                if(vm.cod_empresa > 0){
                    this.$emit('edita-empresa', vm.novo);
                }
                else{
                    this.$emit('cria-empresa', vm.novo);
                }
            ...
            buscaEmpresa(){
                ...
                axios.get("../../rs/empresa/buscar?cod=" + vm.cod_empresa)
                    .then(response => {
                        ...
                        if(error.response.status === 403)
                            ...
                            this.$emit('alerta-erro', error, "Erro ao buscar empresa");
                    }).finally(function(){
